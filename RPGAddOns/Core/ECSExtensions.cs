...
public static class ECSExtensions
{
    ...
    public static unsafe T Reader<T>(this Entity entity) where T : struct
    {
        // Get the ComponentType for T
        var ct = new ComponentType(Il2CppType.Of<T>());
    ...
    public static bool HasType<T>(this Entity entity)
    {
        var ct = new ComponentType(Il2CppType.Of<T>());
    ...
    public static void LogComponentTypes(this Entity entity)
    {
        ...
        {
            RPGAddOns.Core.Plugin.Logger.LogInfo($"{comp}");
        }
        RPGAddOns.Core.Plugin.Logger.LogInfo("===");
    }
    ...
    public static void LogComponentTypes(this EntityQuery entityQuery)
    {
        ...
        {
            RPGAddOns.Core.Plugin.Logger.LogInfo($"Query Component Type: {t}");
        }
        RPGAddOns.Core.Plugin.Logger.LogInfo($"===");
    }
