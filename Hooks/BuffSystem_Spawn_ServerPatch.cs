...
public static class BuffSystem_Spawn_ServerPatch
{
	...
	static List<ModifyUnitStatBuff_DOTS> immortal = new List<ModifyUnitStatBuff_DOTS>()
	{
		PResist,
		FResist,
		HResist,
	...
	static List<ModifyUnitStatBuff_DOTS> nocd = new List<ModifyUnitStatBuff_DOTS>()
	{
		Cooldown
	};

	static List<ModifyUnitStatBuff_DOTS> speed = new List<ModifyUnitStatBuff_DOTS>()
	{
		Speed
	};

	static List<ModifyUnitStatBuff_DOTS> hp = new List<ModifyUnitStatBuff_DOTS>()
	{
		MaxHP
	};

	static List<ModifyUnitStatBuff_DOTS> attackSpeed = new List<ModifyUnitStatBuff_DOTS>()
	{
		AttackSpeed
	};

	static List<ModifyUnitStatBuff_DOTS> damage = new List<ModifyUnitStatBuff_DOTS>()
	{
		PPower,
		RPower,
		SPPower,
	...
	static List<ModifyUnitStatBuff_DOTS> trollDamage = new List<ModifyUnitStatBuff_DOTS>()
	{
		TrollPPower,
		TrollRPower,
		TrollSPPower,
	...
	static Dictionary<string, List<ModifyUnitStatBuff_DOTS>> buffGroups = new Dictionary<string, List<ModifyUnitStatBuff_DOTS>>()
	{
		{"immortal", immortal},
		{"speed", speed},
