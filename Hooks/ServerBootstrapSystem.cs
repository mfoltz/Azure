...
{
    [HarmonyPatch]
    public class HybridModelSystemPatches
    {
        [HarmonyPatch(typeof(HybridModelSystem), nameof(HybridModelSystem.OnUpdate))]
        [HarmonyPrefix]

        private static void OnUpdatePrefix(HybridModelSystem __instance)
        {
            Plugin.Logger.LogInfo("HybridModelSystem OnUpdate called...");
        }
